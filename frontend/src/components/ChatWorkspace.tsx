...
export function ChatWorkspace({ messages, input, loading, historyLoading, tutoringState, disabled = false, disabledMessage = '', inactivityNudge = null, brainBreak = null, brainBreakWarning = '', onActivity, onInputChange, onSend, onQuickAction }: Props) {
